...
variable_name = []
variable_name.append("R2")
variable_name.append("DeltaZ")
variable_name.append("abs_qr")
variable_name.append("thrustBm")
...
lower_range.append(-0.1)
lower_range.append(0)
lower_range.append(0.55)

upper_range = []
upper_range.append(1)
upper_range.append(0.1)
upper_range.append(1)
upper_range.append(1)

histogram_title = []
histogram_title.append("R2")
histogram_title.append("#DeltaZ (cm)")
histogram_title.append("#left| #vec{q}#bullet#vec{r} #right|")
histogram_title.append("Thrust of Signal (T_{B})")
...
if normalization == 1:
    output_filename = "cs_" + sys.argv[6] + "1_" + '_'.join(variable_name) + "_normalized"
else:
    output_filename = "cs_" + sys.argv[6] + "1_" + '_'.join(variable_name)
...
legend.append(ROOT.TLegend(0.7,0.7,0.9,0.9))
legend.append(ROOT.TLegend(0.4,0.7,0.7,0.9))
legend.append(ROOT.TLegend(0.7,0.7,0.9,0.9))
